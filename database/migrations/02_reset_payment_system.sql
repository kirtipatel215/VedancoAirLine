-- ================================================================
-- MIGRATION: 02_RESET_PAYMENT_SYSTEM
-- ================================================================
-- PURPOSE: Clean slate for payment logic to resolve all conflicts
-- ACTIONS: Drop old functions, Recreate with strict verified logic
-- ================================================================

-- 1. DROP EXISTING FUNCTIONS (To remove any old signatures/conflicts)
...
-- 2. RECREATE: Check and Lock Function
...
-- 3. RECREATE: Atomic Payment Init (Strict ACID + Aliased Columns)
...
BEGIN
  ...
  -- FIXED: ALIASED COLUMNS TO PREVENT AMBIGUITY
  SELECT t.id, t.status, t.amount, t.currency INTO v_existing_tx, v_current_status, v_existing_amount, v_existing_currency
  FROM transactions t
...
SELECT 'Payment system reset and verified successfully' as status;
